...
class MainView(ttk.Frame):
    def __init__(self, root, event_controller: EventController):
        ...
        # Create commands
        self.show_add_event_command = ShowAddEventCommand(event_controller)
        ...
        # Show items
        self.item_list = EventMainView(self.root, self.event_controller,
